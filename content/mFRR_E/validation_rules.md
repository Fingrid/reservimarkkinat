...
* Portfolio limit is symmetrical per direction. Quantity limit counts both upwards and downwards bids in the amount of bids. Inclusive bid groups are counted as one bid.
    ...
    * e.g. BSP has a quantity limit of 5 bids, and has submitted an inclusive bid group containing 5 sub-bids. They can still submit 4 more bids.
